        ...
        return (
            <RelatedProduct>
                <div className="container">
                    <div className="row">
                        <h5 className="font-weight-bold text-uppercase title-featured">Related Products</h5>
                    </div>
                    <div className="row">
                        <ProductConsumer>
                            {(value) => {
                                const { relatedProducts: products, handleDetail, addToCart, addToCompare, openModal, openListModal, compare } = value;
                                return (
